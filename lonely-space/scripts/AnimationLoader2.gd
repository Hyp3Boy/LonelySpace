...
func load_animations_into_player():
	...
	# --- CONFIGURACIÓN ---
	var anim_player_path = "Ch14_nonPBR/AnimationPlayer"
	var new_library_name = "movimiento"
	var animations_to_load = {
		"idle": "res://Assets/Models/Animations2/idle.res",
		"run": "res://Assets/Models/Animations2/run.res",
		# Eliminamos la antigua animación de "jump"
		"jump_start": "res://Assets/Models/Animations2/jumping_up.res",
		"jump_loop": "res://Assets/Models/Animations2/falling_idle.res",
		"jump_land": "res://Assets/Models/Animations2/jumping_down.res"
	}
